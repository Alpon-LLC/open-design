...
This project is indexed by GitNexus as **Aeostarsinsight** (3457 symbols, 10676 relationships, 287 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
